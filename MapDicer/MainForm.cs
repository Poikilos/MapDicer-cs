...
using System.Windows.Media.Imaging;  // PresentationCore.dll (provides WriteableBitmap)
using System.Windows.Media;  // PresentationCore.dll (provides Visual)
using System.Windows.Shapes;  // PresentationFramework.dll (provides Ellipse)
using MapDicer.Models;

using System.Collections.ObjectModel;  // System.ObjectModel.dll (provides ObservableCollection)
...
namespace MapDicer
{
    ...
    public partial class MainForm : Form
    {
        ...
        public static MainForm thisMP = null;
        ...
        private MapViewer mapViewer;  // Added for SharpDevelop (Add the Panel subclass manually so Forms designer doesn't break)
        ...
        public MainForm()
        {
            ...
            this.mainTLP.Controls.Add(this.mapViewer, 0, 1);
            this.mapViewer.Location = new System.Drawing.Point(3, 69);
            this.mapViewer.Name = "mapViewer";
            this.mapViewer.Size = new System.Drawing.Size(325, 190);
        ...
        void TerrainColorBtnClick(object sender, EventArgs e)
        {
            // goToAddTerrain();
        }

        void TerrainBtnClick(object sender, EventArgs e)
        {
        ...
        void TerrainBrushSizeSliderScroll(object sender, EventArgs e)
        {
        ...
        */
        ...
        void BrushTerrainCBxSelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        void DetailBtnClick(object sender, EventArgs e)
        {
        ...
        void RegionBtnClick(object sender, EventArgs e)
        {
            SettingController.Start();
        ...
        void MapblockBtnClick(object sender, EventArgs e)
        {
            SettingController.Start();
            if (viewModel.SelectedLod == null)
            {
        ...
        void LodCBxSelectedIndexChanged(object sender, EventArgs e)
        {
            ClearLodDependents();
            LoadLodDependents();
        }

        void TerrainCBxSelectedIndexChanged(object sender, EventArgs e)
        {
            if (viewModel.SelectedTerrain != null)
            {
    ...
    class ViewModel
    {
        ...
        public ObservableCollection<MapDicer.Models.Region> Regions { get; set; }
        ...
        private MapDicer.Models.Region selectedRegion;
        public MapDicer.Models.Region SelectedRegion
        {
