...
namespace MapDicer
{
    ...
    /// </summary>
    public sealed partial class NewTerrainPage : Page
    {
        ...
        private void afterSize(bool InitializeBrush)
        {
            ...
            this.selectSP.Height = this.touchSize * 2;
            this.terrainsAddButtonButton.Width = this.touchSize * 6;
            double selectW = this.selectSP.Width;
            double selectSlackW = selectW - this.terrainsAddButtonButton.Width;
            this.detailCB.Width = selectSlackW * .33;
            this.detailCB.Height = this.terrainsAddButtonButton.Height;
            ...
            this.terrainsAddButtonButton.Height = this.touchSize * 2;
            this.terrainsAddButtonButton.FontSize = touchSize;
        ...
        public NewTerrainPage()
        {
            this.InitializeComponent();
            this.afterSize(true);
        }

        private void NewTerrainPage_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            this.afterSize(true);
        }

        private void terrainsAddButtonAddButton_Click(object sender, RoutedEventArgs e)
        {
            string textTrim = this.colorTB.Text.Trim();
            if (textTrim.Length > 0) {
                Terrain newTerrain = new Terrain(textTrim, redSlider.Value, greenSlider.Value, blueSlider.Value);
                this.Frame.Navigate(typeof(MainPage), newTerrain);
            }
            else
            {
        ...
        private void terrainsAddButtonCancelButton_Click(object sender, RoutedEventArgs e)
        {
